App = {
  ...
  originFarmName: "Jason Wang",
  originFarmInformation: "Skagit Valley",
  originFarmLatitude: "48.4873",
  originFarmLongitude: "122.2471",
  productNotes: "Best Coffee in the PNW",
  productPrice: 1,
  ...
  setupAccounts: function() {
      App.originFarmerID = App.accounts[1];
      App.distributorID = App.accounts[2];
      App.retailerID = App.accounts[3];
      App.consumerID = App.accounts[4];
